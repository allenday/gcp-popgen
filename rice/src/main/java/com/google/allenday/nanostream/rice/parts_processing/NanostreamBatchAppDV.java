...
public class NanostreamBatchAppDV {

    private final static String JOB_NAME_PREFIX = "nanostream-rice-dv-";
    ...
    public static void main(String[] args) {
        ...
        pipeline
                ...
                .apply(ParDo.of(new PrepareDvNotProcessedFn(injector.getInstance(ReferencesProvider.class),
                        geneReferences, 0, 40000, stagedBucket, mergedFilePattern, indexFilePattern, vcfFilePattern)))
